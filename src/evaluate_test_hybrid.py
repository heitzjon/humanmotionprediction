...
def main(config):
    ...
    visualize_multiple_poses([seed_and_prediction], change_color_after_frame=seeds[0].shape[0], action_label=action_labels[idx], visualisation_mode=VisualizationModes.HYBRID)
